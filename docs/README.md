...
| [feature_extraction.md](feature_extraction.md) | Static / symbolic / graph / config features and merged vector layout |
| [CLI_GUIDE.md](CLI_GUIDE.md) | `autoconfig` CLI commands |
| [usage_guide.md](usage_guide.md) | Usage guide (workflow and Python API) |
| [CONFIG_GUIDE.md](CONFIG_GUIDE.md) | Configuration generation and resource catalog |
